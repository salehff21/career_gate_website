...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute([$name, $email, $password])) {
        echo "<script>window.onload = function() { showMessage('تم التسجيل بنجاح! يمكنك الآن تسجيل الدخول.', 'success'); setTimeout(function(){ window.location='loginSeekerjob.php'; }, 2000); }</script>";
    } else {
